...
####################################################################
# Complete ISPConfig setup script for ubuntu 13, 12 (32 or 64 bit) #                                                                                                  #
# W3Space                                                          #                                                                                                                                                #
# http://w3space.net                                               #                                                                    #
####################################################################
...
questions (){
  ...
  do
        HOSTNAMESHORT=$(whiptail --title "Hostname" --backtitle "$back_title" --inputbox "Please specify a Short Hostname" --nocancel 10 50 3>&1 1>&2 2>&3)
  done
...
} #end function ubuntu_install_MySQLCourier

ubuntu_install_MariaDBCourier (){
...
apt-get -y install postfix postfix-mysql postfix-doc mariadb-client mariadb-server courier-authdaemon courier-authlib-mysql courier-pop courier-pop-ssl courier-imap courier-imap-ssl libsasl2-2 libsasl2-modules libsasl2-modules-sql sasl2-bin libpam-mysql openssl getmail4 rkhunter binutils maildrop
...
} #end function ubuntu_install_MariaDBCourier
...
} #end function ubuntu_install_MySQLDovecot

ubuntu_install_MariaDBDovecot (){
...
} #end function ubuntu_install_MariaDBDovecot
